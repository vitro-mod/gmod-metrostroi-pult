...
function ENT:Draw()
	...
	draw.DrawText('ReqSpeed: ' .. (self:GetRequiredSpeed()), 'Trebuchet24', -70, -170, Color(255, 100, 0))
	draw.DrawText('Signal: ' .. (self:GetAdjacentSignalName()), 'Trebuchet24', -70, -150, Color(255, 100, 0))
